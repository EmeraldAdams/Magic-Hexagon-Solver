#Backtracking with Forward checking propagtion and Mininuim Remaing Value 
import time
import tracemalloc

class CSP:
    def __init__(self, variables, domains, constraints, sum_value=38, log_filename="ForwardcheckingMinRemaining.txt"):
        self.variables = variables
        self.domains = domains
        self.constraints = constraints
        self.sum_value = sum_value
        self.assignment = {'A': 3, 'B': 17 }  # Initial assignments if any
    ...
    def select_unassigned_variable(self):
        ...
        def num_legal_values(var):
            return sum(self.is_consistent(var, value) for value in self.domains[var])
        
        return min(unassigned_variables, key=num_legal_values)
...
if __name__ == "__main__":
    ...
    print("Forward Checking and MRV")
    print(solution)
